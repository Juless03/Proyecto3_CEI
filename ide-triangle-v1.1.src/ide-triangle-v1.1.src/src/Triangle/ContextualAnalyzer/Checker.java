...
public final class Checker implements Visitor {
    ...
    public Object visitForCommand(ForCommand ast, Object o) {
        // Comprueba que la variable de control del bucle es un entero.
...
//    }
        // Comprueba que la expresión de inicio del bucle es un entero.
        TypeDenoter e1Type = (TypeDenoter) ast.E1.visit(this, null);
        if (!(e1Type.equals(StdEnvironment.integerType))) {
            reporter.reportError("Integer expression expected here", "", ast.E1.position);
        }

        // Comprueba que la expresión final del bucle es un entero.
        ...
        // Comprueba que la variable de control del bucle es menor que la expresión final del bucle.
        // Puedes necesitar añadir código adicional para comprobar esto, dependiendo de cómo esté implementado tu lenguaje.
        // Comprueba el comando del cuerpo del bucle.
        ast.C.visit(this, null);
    ...
    public Object visitCaseCommand(CaseCommand ast, Object o) {
        // Revisamos que la expresión sea de tipo entero.
        TypeDenoter eType = (TypeDenoter) ast.E.visit(this, null);
        if (!eType.equals(StdEnvironment.integerType)) {
            reporter.reportError("Integer expression expected here", "", ast.E.position);
        }

        // Revisamos todos los literales de los casos
        for (Map.Entry<IntegerLiteral, Command> entry : ast.CC.entrySet()) {
            IntegerLiteral il = entry.getKey();
            Command c = entry.getValue();

            // Comprobamos que el literal es de tipo entero
            TypeDenoter ilType = (TypeDenoter) il.visit(this, null);
            if (!ilType.equals(StdEnvironment.integerType)) {
                reporter.reportError("Integer literal expected here", "", il.position);
            }

            // Visitamos el comando correspondiente al literal
            c.visit(this, null);
        }

        // Visitamos el comando del else
        ast.C.visit(this, null);

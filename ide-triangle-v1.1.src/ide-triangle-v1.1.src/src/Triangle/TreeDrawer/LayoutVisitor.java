...
public class LayoutVisitor implements Visitor {
  ...
  public Object visitWhileCommand(WhileCommand ast, Object obj) {
    ...
    public Object visitCaseCommand(CaseCommand ast, Object obj) {
        // Preparar un layout para la expresión
    DrawingTree expressionLayout = layoutUnary("CaseExp.", ast.E);

    // Preparar un layout para cada par IntegerLiteral-Command en el HashMap
    ArrayList<DrawingTree> caseLayouts = new ArrayList<>();
    for (Map.Entry<IntegerLiteral, Command> entry : ast.CC.entrySet()) {
        IntegerLiteral literal = entry.getKey();
        Command command = entry.getValue();
        DrawingTree layout = layoutBinary("Case:", literal, command);
        caseLayouts.add(layout);
    }

    // Concatenar todos los layouts en un solo String
    DrawingTree result = expressionLayout;
  ...
  public Object visitNilExpression(NilExpression ast,Object obt){
    ...
    public Object visitNewExpression(NewExpression ast,Object obt){
        return layoutUnary("NewExpr.",ast.I);
    }
